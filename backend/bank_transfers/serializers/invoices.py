"""
NAV Invoice Synchronization Serializers Module

This module contains serializers for NAV (Hungarian Tax Authority) invoice integration:
- NAV configuration and sync logs
- Invoice models with line items
- Invoice list and detail views with formatted fields
- Invoice statistics and payment status tracking
- Trusted partners for automated payment processing

All invoice serializers are READ-ONLY as data is synced from NAV API.
"""
