...
EXEC #SafeAddProperty @name = N'MS_Description', @value = N'Recipients of bank transfers. Contains account details, VAT numbers, contact information, and transfer preferences per company. Supports both bank account and VAT number identification.', @level0type = N'SCHEMA', @level0name = 'dbo', @level1type = N'TABLE', @level1name = 'bank_transfers_beneficiary';
...
EXEC #SafeAddProperty @name = N'MS_Description', @value = N'Bank account number for receiving transfers (nullable - can use VAT number instead)', @level0type = N'SCHEMA', @level0name = 'dbo', @level1type = N'TABLE', @level1name = 'bank_transfers_beneficiary', @level2type = N'COLUMN', @level2name = 'account_number';
EXEC #SafeAddProperty @name = N'MS_Description', @value = N'Hungarian personal VAT number (személyi adóazonosító jel) - 10 digits (e.g. 8440961790). Nullable when account_number is provided.', @level0type = N'SCHEMA', @level0name = 'dbo', @level1type = N'TABLE', @level1name = 'bank_transfers_beneficiary', @level2type = N'COLUMN', @level2name = 'vat_number';
...
EXEC #SafeAddProperty @name = N'MS_Description', @value = N'Payment status tracking: UNPAID (Fizetésre vár), PREPARED (Előkészítve), PAID (Kifizetve)', @level0type = N'SCHEMA', @level0name = 'dbo', @level1type = N'TABLE', @level1name = 'bank_transfers_invoice', @level2type = N'COLUMN', @level2name = 'payment_status';
EXEC #SafeAddProperty @name = N'MS_Description', @value = N'Date when payment status was last changed', @level0type = N'SCHEMA', @level0name = 'dbo', @level1type = N'TABLE', @level1name = 'bank_transfers_invoice', @level2type = N'COLUMN', @level2name = 'payment_status_date';
EXEC #SafeAddProperty @name = N'MS_Description', @value = N'Whether invoice was automatically marked as paid during batch processing (1=automatic, 0=manual)', @level0type = N'SCHEMA', @level0name = 'dbo', @level1type = N'TABLE', @level1name = 'bank_transfers_invoice', @level2type = N'COLUMN', @level2name = 'auto_marked_paid';
